...
\begin{figure}[h]
	\includegraphics[scale=1.1]{./metrics_Feb162020.pdf}
	%	\centering
\end{figure}
...
%~\\
22. \textbf{Bagley JC}, Heming NM, Guti\'{e}rrez EE, Devisetty UK, Mock KE, Eckert AJ,\\
\hspace*{8mm} Strauss SH (\emph{in revision}) Genotyping-by-sequencing and ecological niche \\
...
%~\\
21. \textbf{Bagley JC}, Aquino PPU, Hrbek T, Hernandez S\textsuperscript{G}, Langeani F, Colli GR (\emph{in}\\
...
%~\\
20. Menon M, \textbf{Bagley JC}, Page G, Whipple AV, Schoettle AW, Still C, Wehenkel\\
...
%~\\
19. \textbf{Bagley JC}, Uribe-Convers S, Carlsen M, Muchhala N (\emph{accepted}) Utility of\\
...
\hspace*{8mm}\textbf{genetics and Evolution}}.\\
%~\\
...
\centering
\textit{Last update:} 16 February 2020 \\
%\textit{URL:} 
